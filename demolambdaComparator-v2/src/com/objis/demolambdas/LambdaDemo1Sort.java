...
public class LambdaDemo1Sort {
	...
	public static void main(String[] args) {
	   ...
	   //PB N°1. On aimerait bien pouvoir passer la méthode compare() 
	   // ci-dessous en second argument à Collections.sort(personnes, xxxx) 
	   // MAIS pas possible avant Java 8 ! --> on ne peut passer une fonctions en paramètre d'une méthode 
	   // --> On DOIT créer classe implémentant interface Comparator (ici classe ComparaPersonneParNom)
	   
	   //PB N°2. On aimerait bien pouvoir passer directement la classe ComparaPersonneParNom,
	   // MAIS pas possible avant Java 8 !
	   // --> in faut instancier la classe car la méthode sort prend une instance
